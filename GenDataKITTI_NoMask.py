...
STEPSIZE = 1
#result output dir
OUTPUT_DIR = "/home/ubuntu/data/kitti_result_all_20200507"
#temp data dir
TEMP_DIR="/home/ubuntu/data/train_data_example_all_20200507/"
...
def make_dataset():
    ...
    for dataset in data_dirs:
        ...
        make_mask_images_nomask(OUTPUT_DIR2,file_names,dataset,IMAGE_DIR)
